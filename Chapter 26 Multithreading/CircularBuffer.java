...
public class CircularBuffer implements Buffer {
    ...
    public synchronized int get() throws InterruptedException {
        ...
        --occupiedCells; // one fewer buffer cells are occupiedCells
